...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-full w-full items-center justify-center overflow-y-auto bg-[radial-gradient(circle_at_top,rgba(34,197,94,0.14),transparent_32%),linear-gradient(180deg,hsl(var(--surface-1))_0%,hsl(var(--background))_58%)] px-4 py-10">
                ...
                <section className="relative border-b border-muted px-6 py-8 sm:px-8 lg:border-b-0 lg:border-r lg:px-10 lg:py-10">
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-6 max-w-xl text-[13px] leading-6 text-muted-foreground">
                            ...
                            GitHub sync controls in one place. Created by Rushi
                            Panchl.
                        </p>
                    ...
                    <div className="mx-auto w-full max-w-md">
                        <div>
                            ...
                            <p className="mt-2 text-[12px] leading-5 text-muted-foreground">
                                Sign in with the backend-powered admin account.
                                This form now uses the real admin auth API and
                                opens the app only after the server session is
                                ready.
                            </p>
                        </div>
